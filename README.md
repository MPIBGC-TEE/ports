...
* sometimes forwarding of ports has to be canceled to free them for new use,
...
## Order
* [ex0](examples/ex0),[ex0_b](examples/ex0_b)
* [ex1](examples/ex1)
* [ex2](examples/ex2)
* [ex3](examples/ex3)
* [ex4](examples/ex4)
...
We show the annoying aspects of this manual approach and use them to motivate gradual improvements leading to the next implementation.
...
to show the development of the final solution, which would be a bit hard to read otherwise.
